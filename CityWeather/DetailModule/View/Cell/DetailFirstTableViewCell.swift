...
class DetailFirstTableViewCell: UITableViewCell {
    let cityAndFeelsLikeLabel = UILabel().createLabel(textAlignment: .center, numberOfLines: 3, font: UIFont.systemFont(ofSize: 18.0), textColor: .white)
    ...
    let descriptionLabel = UILabel().createLabel(textAlignment: .center, numberOfLines: 1, font: UIFont.systemFont(ofSize: 18.0), textColor: .white)
